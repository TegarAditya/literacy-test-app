...
const customers = ref([
    { name: 'John', country: { name: 'USA' }, company: 'Company A', representative: { name: 'Alex' } },
    { name: 'Paul', country: { name: 'Canada' }, company: 'Company B', representative: { name: 'Bruce' } },
    { name: 'George', country: { name: 'Mexico' }, company: 'Company C', representative: { name: 'Lee' } },
    { name: 'Ringo', country: { name: 'Brazil' }, company: 'Company D', representative: { name: 'Mike' } },
    { name: 'Paul', country: { name: 'Canada' }, company: 'Company B', representative: { name: 'Bruce' } },
    { name: 'George', country: { name: 'Mexico' }, company: 'Company C', representative: { name: 'Lee' } },
    { name: 'Ringo', country: { name: 'Brazil' }, company: 'Company D', representative: { name: 'Mike' } }
]);
...
const responses = useState('responses', () => {
    return JSON.stringify(customers.value);
});
